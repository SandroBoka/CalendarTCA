...
enum EventCategory: String, CaseIterable, Identifiable, Codable, Hashable {
    ...
    /// Primary “brand” color (matches the zip / design palette)
    var hex: String {
        switch self {
        case .jHilburn: return "#0F78C4"
        case .birthdays: return "#C88500"
        case .deliveries: return "#009160"
        case .notes: return "#9F1D8A"
        case .stylistEvents: return "#C21E2A"
        case .closures: return "#4C4D53"
        }
    }
